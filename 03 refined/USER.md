...
- **Name:** meiqiao
- **How to address:** meiqiao, or just "you"
...
- Data engineer: building platforms and data pipelines

**Technical interests:**
1. **Data engineering** — core of daily work: build data/AI products building
2. **AI/LLM** — actively learning and practicing: LLM applications, AI-native workflows
3. **Self-exploration and cognition** — knowing herself through writing, creation and systematic reflection

**Writing and communication style:**
- Technical but not obscure
- Opinionated and analytical 
...
**Philosophy:**
- Goal: build systems that extend her own capabilities
- Views AI as an amplifier and agent, not a replacement
- Believes the future belongs to those who can orchestrate AI
...
- She values authenticity and depth
